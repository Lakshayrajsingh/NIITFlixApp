package com.muzix.MovieDisplayService.JWTFilter;
...
//        else: verify the token ,process request /don't  process the request
        if (authHeader==null || !authHeader.startsWith("Bearer")){
            throw new ServletException("token missing");
        }
        else {
//            authHeader existing + Bearer token
//            authHeader: Bearer_xxxxxxxxxxxx
